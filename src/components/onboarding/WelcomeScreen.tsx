...
export function WelcomeScreen() {
  ...
  return <Box width="100%" minHeight="100vh" background="linear-gradient(200deg, rgb(0, 35, 66) 50%, rgb(0, 18, 34))" color="white" position="relative" overflow="hidden">
      ...
      <Flex minHeight="calc(100vh - 72px)" marginTop="72px" alignItems="center" justifyContent="center" direction="column" p={4} position="relative" zIndex={2}>
        <Box maxW="500px" width="100%" background="linear-gradient(to right bottom, rgba(216, 241, 252, 0.32), rgba(216, 241, 252, 0.08), rgba(216, 241, 252, 0.16))" borderRadius="16px" p={8} pb={10} position="relative" sx={{
        boxShadow: `
        ...
        zIndex: 0
          ...
          <VStack spacing={8} textAlign="center">
            <Box>
              <Heading as="h1" size="4xl" fontWeight="900" letterSpacing="tight" lineHeight="1.1" mb={4}>
                Your Show Your Way
              </Heading>
              <Text fontSize="xl" fontWeight="medium" opacity={0.9} maxW="600px" mx="auto">
                The Ramsey Show tailored to you and what you want to learn.
              </Text>
            </Box>
            <Button size="lg" bg="white" color="rgb(0, 115, 185)" rightIcon={<ArrowRight />} fontWeight="semibold" fontSize="18px" height="50px" px={8} letterSpacing="1.6px" onClick={() => setShowQuestion(true)} _hover={{
